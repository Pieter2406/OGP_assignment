...
public class ComposedExpressionTest {
	...
	@Test public void canHaveAsOperandAt_NonEffectiveOperand() {
		assertFalse(someComposedExpression.canHaveAsOperandAt(null,1));
	}
	...
	@Test public void canHaveAsOperand_CyclicOperand() throws Exception {
		...
		assertFalse(someComposedExpression.canHaveAsOperandAt(moreComposedExpression,1));
	}
	
	@Test public void canHaveAsOperandAt_NonPositiveIndex() {
		assertFalse(someComposedExpression.canHaveAsOperandAt(new IntegerLiteral(12),0));
	}
