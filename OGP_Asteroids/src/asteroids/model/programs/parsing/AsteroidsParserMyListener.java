...
import asteroids.model.programs.parsing.AsteroidsParserParser.FunctionContext;
import asteroids.model.programs.parsing.AsteroidsParserParser.FunctioncallContext;
...
public class AsteroidsParserMyListener<E, S, T> implements AsteroidsParserListener {
	...
	private S StatementOfFunction(TerminalNode identifier, AsteroidsParserParser.FunctionContext function){
		if(function == null)
			return null;
		return null;
	}
