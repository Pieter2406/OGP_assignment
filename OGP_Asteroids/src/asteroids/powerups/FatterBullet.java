 ...
 * 
 */
public class FatterBullet extends SpaceObject {
	 ...
	 * @param minimumRadius
	 */
	public FatterBullet(double x, double y, double velocityX, double velocityY,
	 ...
	 * @param minimumRadius
	 */
	public FatterBullet(double radius, double minimumRadius) {
